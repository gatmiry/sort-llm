#!/bin/bash
# SLURM batch script for single-length training length generalization without layer norm (SortGPT)

#SBATCH --job-name=sortgpt_len_gen_single_no_ln
#SBATCH --account=chip
...
#SBATCH --output=logs/len_gen_single_no_ln-%A_%a.out
#SBATCH --array=0-83
...
GROUP_NAME="len_gen_single_no_ln_k${TRAIN_K}"
