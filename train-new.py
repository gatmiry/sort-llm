...
data_loader = DataLoader(block_size, batch_size, vocab_size)
max_iter = 20001
for itr in range(max_iter):
   #print(f'itr: {itr}')
   optimizer.zero_grad()
   x, y = data_loader.get_bubble_batch()
   ...
   if itr % 10000 == 0:
      ...
      import os
      torch.save(checkpoint, os.path.join(os.getcwd(), f'./saved_models/bubble_evenn_itr:{itr}.pt'))
